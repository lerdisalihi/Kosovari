...
export function Admin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-green-100 via-blue-50 to-blue-200 py-8 px-4 flex flex-col items-center animate-fadeIn">
      <div className="mb-8 w-full max-w-7xl bg-white/90 rounded-2xl shadow-2xl p-8 backdrop-blur-md animate-fadeInUp">
        <h1 className="text-3xl font-bold mb-6">Admin Dashboard</h1>
        {/* Statistics Grid */}
        <div className="grid grid-cols-4 gap-4 mb-8">
          {/* Total Issues Card */}
          <div className="bg-blue-100/80 p-6 rounded-xl text-center shadow-md">
            <h3 className="text-xl font-semibold mb-2">Total Issues</h3>
            <p className="text-3xl font-bold text-blue-600">{issues.length}</p>
          </div>
          {/* Open Issues Card */}
          <div className="bg-yellow-100/80 p-6 rounded-xl text-center shadow-md">
          ...
          {/* In Progress Card */}
          <div className="bg-purple-100/80 p-6 rounded-xl text-center shadow-md">
          ...
          <div className="bg-green-100/80 p-6 rounded-xl text-center shadow-md">
        ...
        {/* Issues Table */}
        <div className="bg-white/90 shadow-xl rounded-2xl overflow-hidden backdrop-blur-sm">
