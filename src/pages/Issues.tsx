...
export default function Issues() {
  ...
  return (
    <div className="flex-1 bg-gradient-to-tr from-green-100 via-blue-50 to-blue-200 overflow-y-auto min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {sortedIssues.map((issue, index) => {
              ...
              return (
                <div
                  key={issue.id}
                  className="bg-white/90 rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-shadow backdrop-blur-sm"
