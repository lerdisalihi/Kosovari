...
export function Home() {
  ...
  return (
    <div className="h-full w-full relative">
      ...
      {user === null && (
        <div className="absolute top-8 right-8 z-20 w-96 max-w-full bg-gradient-to-tr from-green-100 via-blue-50 to-blue-200 border-4 border-green-200 rounded-3xl shadow-2xl p-8 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-md">
          ...
          />
          <h2 className="text-xl font-extrabold text-emerald-700 mb-2 text-center tracking-tight">What is KosovAR?</h2>
          ...
          <div className="flex flex-col items-center mt-2">
            <span className="text-emerald-600 font-semibold text-xs mb-1">Scan a QR code to view in AR:</span>
            <img
              src="KosovARi.png"
          ...
          <div className="flex flex-col items-center mt-4">
            <span className="text-emerald-600 font-semibold text-xs mb-1">Need help?</span>
            <a
              href="/assets/user-manual.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-700 underline font-normal text-xs hover:text-blue-900 transition-colors duration-200"
            >
