...
export default function UserProfile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-green-100 via-blue-50 to-blue-200 py-8 px-4 flex flex-col items-center animate-fadeIn">
      <div className="bg-white/90 rounded-2xl shadow-2xl p-8 flex flex-col items-center w-full max-w-3xl backdrop-blur-md animate-fadeInUp">
      ...
      <div className="grid grid-cols-3 gap-4 mt-8 w-full">
        <div className="bg-blue-100/80 p-4 rounded-xl text-center shadow-md">
        ...
        <div className="bg-yellow-100/80 p-4 rounded-xl text-center shadow-md">
          <div className="text-lg font-semibold">Comments</div>
          <div className="text-3xl font-bold text-yellow-600">{comments.length}</div>
        </div>
        <div className="bg-pink-100/80 p-4 rounded-xl text-center shadow-md">
        ...
        <div className="space-y-4">
          {userIssues.length === 0 ? (
            ...
            userIssues.map(issue => (
              <div key={issue.id} className="bg-white/80 shadow-lg rounded-xl p-4 flex items-center gap-4 backdrop-blur-sm">
                {issue.image_url && (
        ...
        <div className="space-y-4">
          {comments.length === 0 ? (
            ...
            comments.map(comment => (
              <div key={comment.id} className="bg-gray-50/80 rounded-xl p-3 shadow backdrop-blur-sm">
      ...
      {passwordModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-gradient-to-tr from-green-100 via-blue-50 to-blue-200 rounded-2xl p-6 w-full max-w-md relative shadow-2xl backdrop-blur-md animate-fadeInUp">
            <button
